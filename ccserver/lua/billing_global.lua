...
local _M = { 
    ...
    ERR_INVALID_JSON_FORMAT = ERR_BASE_ERROR-7,
    
    ERR_DB_ALLOC = ERR_BASE_ERROR-8,
    ERR_DBINIT = ERR_BASE_ERROR-9,
    ERR_DBDEINIT = ERR_BASE_ERROR-10,

    ERR_MOD_GETGAMELISTPORT_BASE = ERR_BASE_ERROR-100,
    ERR_MOD_GETGAMEREGION_BASE = ERR_BASE_ERROR-200,
    ERR_MOD_GETVPNLST_BASE = ERR_BASE_ERROR-300,
	ERR_MOD_GETCCLST_BASE = ERR_BASE_ERROR-400
