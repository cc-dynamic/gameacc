...
local MOD_ERR_BASE = wei_global.ERR_MOD_GETGAMEBRIEF_BASE
...
function _M.get_all_region(self,db)
    ...
    if not res then
    	wei_global:returnwithcode(self.MOD_ERR_GETREGION,nil)
    end
...
function _M.getbrieflist(self,db)
    ...
    if not res then
    	wei_global:returnwithcode(self.MOD_ERR_GETBRIEFLIST,nil)
    end
...
function _M.getdetectlist(self,db)
    ...
    if not res then
    	wei_global:returnwithcode(self.MOD_ERR_GETDETECTLIST,nil)
    end
